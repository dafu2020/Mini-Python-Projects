...
def roll_die(number_of_rolls, number_of_sides):
    ...
    :postcondition: return the sum of the points from individual roll.
    :return: the sum of the points from individual roll as an integer.
...
def generate_name(syllables):
    ...
    2）Patten matching: similar logic to roll_die function above, use while loop to combine
...
def select_class():
    ...
    3) Generalization：this logic can be used with similar questions that keep asking the user to enter the inputs, until
...
def select_race():
    ...
    1) Decomposition: create a dictionary that contains all races in the Dungeons & Dragons world to corresponding
                      number; create a while loop that force the player to enter the correct number of the corresponding
                      race.
    2）Patten matching: similar logic to the select_class() function above.
    3) Algorithms: use the properties of the dictionary, creates key-value pairs of numbers and corresponding races.
                   ...
                   user entered, and loop ends.
    4) Generalization：this logic can be used with similar questions that keep asking the user to enter the inputs, until
                       certain condition to break the loop.
...
def print_character(character):
    ...
    2) Algorithms: use the properties of the dictionary, create a for loop that print the 'key' and the corresponding
                   'value' one by one.
    4) Generalization：use the same approach to modify the key-value pairs of other dictionaries.
    ...
    >>> character_input = {'Name': 'Du','Strength': 3,'Intelligence': 3,'Wisdom': 3,'Dexterity': 3,'Constitution': 3,'Charisma': 3,'inventory': [],'XP': 0,'class': 'Rogue','Race': 'Dragonborn','HP': [7, 7]}
    ...
    >>> character_input = {'Name': 'Somi','Strength': 10,'Intelligence': 5,'Wisdom': 13,'Dexterity': 9,'Constitution': 12,'Charisma': 9,'inventory': [],'XP': 0,'class': 'sorcerer','Race': 'Elf','HP': [6, 6]}
    >>> print_character(character_input)
    Name Somi
    Strength 10
    Intelligence 5
    ...
    >>> character_input = {'Name': 'Dubibi','Strength': 18,'Intelligence': 18,'Wisdom': 18,'Dexterity': 18,'Constitution': 18,'Charisma': 18,'inventory': ['sword'],'XP': 0,'class': 'Barbarian','Race': 'Tiefling','HP': [12, 12]}
    >>> print_character(character_input)
    Name Dubibi
    Strength 18
    Intelligence 18
...
def combat_round(opponent_one, opponent_two):
    ...
    3) Algorithms: create a while loop to force the players to roll different points，if the players rolls the same point
...
def main():
    """
    Initiate the text-based Dungeons and Dragons game, and initiate the doctests.

    :precondition: the input of syllables must be a positive non-zero integer.
    :postcondition: modify the character dictionaries of the characters that participated the combat.
    ...
    # ask the player to acquire some inventory
