...
class Test(TestCase):
    ...
    def test_length_one_integer_pos_neg_add_to_zero(self):
        """Test two length one sparse vectors contain positive and negative integer elements added to zero"""
        argument_one = {0: 1, 'length': 1}
        argument_two = {0: -1, 'length': 1}
        expected = {'length': 1}
        actual: dict = sparse_vector.sparse_add(argument_one, argument_two)
    ...
    def test_length_more_than_one_same_position_same_integer(self):
        """Test two length more than one sparse vectors contain same positive integer elements at same position"""
    ...
    def test_length_more_than_one_different_position_different_integer(self):
        """Test two length more than one sparse vectors contain different positive integer elements at different position"""
    ...
    def test_length_more_than_one_different_integer_pos_and_neg_add_to_zero(self):
        """Test two length more than one sparse vectors with different positive and negative
            integer elements added to zero"""
